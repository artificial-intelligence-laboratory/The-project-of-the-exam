    ...
    <view>
        <view class="submit">
            <view class="submit-chat">
                ...
                <!-- 文本框 -->
                <textarea auto-height="true" class="chat-send btn" :class="{displaynone:isrecord}" @input="inputs" placeholder="输入聊天内容..."
                ...
                <view class="bt-img" @tap="emoji">
                    <image src="/static/emoji.png"></image>
                </view>
            ...
            <view class="emoji" :class="{displaynone:!isemoji}">
                <view class="emoji-send">
                    <view class="emoji-send-det" @tap="emojiBack">
                        <image src="/static/deleteMSG.png"></image>
                    </view>
